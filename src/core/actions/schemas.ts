...
export const buttonTriggerSchema = z.enum(['press', 'release', 'longPress', 'shiftPress', 'shiftLongPress']);

/** Encoder trigger schema */
export const encoderTriggerSchema = z.enum([
  'rotateCW', 'rotateCCW', 'press', 'release', 'longPress',
